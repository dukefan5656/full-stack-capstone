...
describe("SIGNUP", () => {
  ...
  test("SUCCESS", () => {
    ...
    store.dispatch(
      Actions.signupSuccess({
        user: { _id: "id", type: "type", local: { email: "em" } }
      })
    );
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      return store
        .dispatch(Actions.signup("email", "password", "type"))
        .then(() => {
...
describe("LOG_IN", () => {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      return signup("email", "password", "type")
        .then(() => store.dispatch(Actions.logIn("email", "password")))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
...
describe("ADD_LISTING", () => {
  ...
  describe("REQUEST", () => {
    test("Agent can't create listings", () => {
      ...
      return signup("fail to create", "listing", "agent")
        .then(() => store.dispatch(Actions.addListing({ headline: "hl" })))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
          ...
          expect(actions[1].message.message).toMatch(
            'API: {"message":"You are not a seller"}'
          );
        });
    });
    ...
    test("fields must be their correct type", () => {
      ...
      return signup("invalid field create", "listing", "seller")
        .then(() => store.dispatch(Actions.addListing(args)))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
    ...
    test("SUCCESS", () => {
      ...
      let userID = null;
      return signup("create", "listing", "seller")
        .then(json => {
...
describe("ADD_BID", () => {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      let userID = null;
      let listingID = null;
      return signup("add listing", "for bid", "seller")
        .then(() => addListing({}))
        .then(json => {
          listingID = json._id;
    ...
    test("FAILURE", () => {
      ...
      return signup("add failing", "bid", "agent")
        .then(() => store.dispatch(Actions.addBid(1234, "lid")))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
...
describe("UPDATE_BID", () => {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      let listingID = null;
      let bidID = null;
      return signup("add listing", "for bid update", "seller")
        .then(() => addListing({}))
        .then(json => {
          listingID = json._id;
    ...
    test("FAILURE", () => {
      ...
      return signup("update fail", "bid", "agent")
        .then(() => store.dispatch(Actions.updateBid(1234, "newstatus")))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
...
describe("GET_LISTING", () => {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      let listingID = null;
      let bids = null;
      return signup("add listing", "for listing get", "seller")
        .then(json => {
        ...
        .then(() => store.dispatch(Actions.getListing(listingID)))
        .then(() => {
          const [request, success] = store.getActions();
          expect(request).toEqual({
          ...
          expect(success).toMatchObject({
            ...
            entities: {
              bids: {
                ...bids.reduce((obj, bid) => ({ ...obj, [bid._id]: bid }), {})
              },
              listings: {
                [listingID]: {
                  __v: 2,
    ...
    test("FAILURE", () => {
      ...
      return signup("get listing fail", "pw", "agent")
        .then(() => store.dispatch(Actions.getListing(1234)))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
...
describe(`GET_AGENT_PAYLOAD`, () => {
  ...
  test("SUCCESS", () => {
    ...
    store.dispatch(
      Actions.getAgentPayloadSuccess({
        user: {
          _id: "uid",
          bids: [
            {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      let agentID = null;
      let bid = null;
      return signup("add listing", "for agent payload", "seller")
        .then(json => {
          sellerID = json.user._id;
          return addListing({});
        })
    ...
    test("FAILURE", () => {
      ...
      return logout()
        .then(() => store.dispatch(Actions.getAgentPayload()))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
...
describe(`GET_SELLER_PAYLOAD`, () => {
  ...
  test("SUCCESS", () => {
    ...
    store.dispatch(
      Actions.getSellerPayloadSuccess({
        user: {
          _id: "uid",
          listings: [
            {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      let agentID = null;
      let bid = null;
      return signup("add listing", "for seller payload", "seller")
        .then(json => {
          sellerID = json.user._id;
          return addListing({});
        })
        ...
        .then(() => store.dispatch(Actions.getSellerPayload()))
        .then(() => {
          const [request, success] = store.getActions();
          expect(request).toEqual({
...
describe("DELETE_LISTING", () => {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      let listingID = null;
      return signup("delete", "listing", "seller")
        .then(() => addListing({}))
        .then(json => {
          listingID = json._id;
    ...
    test("FAILURE", () => {
      ...
      return signup("fail delete", "listing", "seller")
        .then(() => store.dispatch(Actions.deleteListing(4567, [0, 4])))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
...
describe("DELETE_BID", () => {
  ...
  describe("REQUEST", () => {
    test("SUCCESS", () => {
      ...
      let listingID = null;
      let bidID = null;
      return signup("delete", "bid", "seller")
        .then(() => addListing({}))
        .then(json => {
          listingID = json._id;
          return signup("delete success", "bid", "agent");
        })
        .then(() => addBid(listingID, 976))
        .then(json => {
          bidID = json._id;
    ...
    test("FAILURE", () => {
      ...
      return signup("fail delete", "bid", "seller")
        .then(() => store.dispatch(Actions.deleteBid(4567)))
        .then(() => {
          const actions = store.getActions();
          expect(actions).toMatchObject([
            {
