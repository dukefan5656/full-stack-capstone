...
describe("Signup", () => {
  ...
  it("updates state when inputs change", () => {
    ...
    wrapper
      ...
      .simulate("change", { target: { value: "newemail" } });
  ...
  it("calls signup", () => {
    ...
    wrapper
      .find("input[name='type'][value='agent']")
      .simulate("change", { target: { value: "agent" } });
    wrapper
      .find("input[name='type'][value='seller']")
      .simulate("change", { target: { value: "seller" } });
